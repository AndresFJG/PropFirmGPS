              ...
              <div className="relative">
                ...
                {isToolsMenuOpen && (
                  <div className="absolute top-full left-0 mt-1 w-48 rounded-md shadow-lg bg-[#1e222d] border border-[#2a2e39]">
                    <div className="py-1">
                      {toolsItems.map((item) => (
                        <Link key={item.path} to={item.path} className="flex items-center px-4 py-2 text-sm text-[#d1d4dc] hover:bg-[#2962ff]/10 hover:text-[#2962ff]" onClick={() => setIsToolsMenuOpen(false)}>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-[#1e222d] border-t border-[#2a2e39]">
              <div className="px-2 pt-2 pb-3 space-y-1">
                <Link to="/" className={`block px-3 py-2 rounded-md text-base font-medium transition-all duration-200 ${location.pathname === '/' ? 'text-[#2962ff] bg-[#2962ff]/10' : 'text-[#d1d4dc] hover:text-[#2962ff] hover:bg-[#2a2e39]'}`}>Inicio</Link>
                <Link to="/articulos" className={`block px-3 py-2 rounded-md text-base font-medium transition-all duration-200 ${location.pathname.includes('/articulos') ? 'text-[#2962ff] bg-[#2962ff]/10' : 'text-[#d1d4dc] hover:text-[#2962ff] hover:bg-[#2a2e39]'}`}>Artículos</Link>
                <Link to="/centro-recursos" className={`block px-3 py-2 rounded-md text-base font-medium transition-all duration-200 ${location.pathname.includes('/centro-recursos') ? 'text-[#2962ff] bg-[#2962ff]/10' : 'text-[#d1d4dc] hover:text-[#2962ff] hover:bg-[#2a2e39]'}`}>Educación</Link>
                <Link to="/top-firms" className={`block px-3 py-2 rounded-md text-base font-medium transition-all duration-200 ${location.pathname.includes('/top-firms') ? 'text-[#2962ff] bg-[#2962ff]/10' : 'text-[#d1d4dc] hover:text-[#2962ff] hover:bg-[#2a2e39]'}`}>Top Firmas</Link>
